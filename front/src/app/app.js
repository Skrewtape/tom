...
// //	    'fcsa-number',
 	    ...
 	    'app.tournamentselect_scorekeeper',
             ...
             'app.test','app.remove_player','app.machine_edit','app.edit_division_divisionselect','app.player_add_queue','app.player_view_queues','app.player_select_queues','app.player_remove_queue','app.player_see_queue',/*REPLACEMECHILD*/
	]
);
