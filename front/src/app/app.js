...
app = angular.module(
	...
	[
	    ...
	    'app.player_add',
	    'app.tournament_activate','app.playerselect_ticket_purchase','app.teamname_team_add','app.playerlist','app.playerselect_player_edit','app.metadivision_add','app.user_add',/*REPLACEMECHILD*/
	]
);
